      ...
      <main className="min-h-screen selection:bg-cyan-500/30">
        ...
        <section className="relative pt-40 pb-24 md:pt-48 md:pb-32 overflow-hidden">
          <div className="container relative z-10 mx-auto px-6 max-w-7xl">
            ...
            >
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tight tracking-tight mb-8 leading-tight">
                We're Not <br/>
              ...
              {values.map((val, idx) => (
                ...
                >
                  <div className="modern-card p-8 h-full">
                    ...
                    <h3 className="text-2xl font-black uppercase tracking-tight mb-3">{val.title}</h3>
          ...
          <div className="w-full px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-8">Our Culture</h2>
                <div className="space-y-6 text-lg leading-relaxed font-medium">
                  ...
                  <div className="pt-6 grid grid-cols-2 gap-6">
                    <div className="modern-card p-6">
                      ...
                      <h4 className="font-black uppercase tracking-tight mb-2">Remote-First</h4>
                      <p className="text-sm font-medium">Talent has no borders.</p>
                    </div>
                    <div className="modern-card p-6">
                      <Zap className="w-8 h-8 mb-4" />
                      <h4 className="font-black uppercase tracking-tight mb-2">Creative Freedom</h4>
              ...
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-8">Working Philosophy</h2>
        ...
        <section className="py-24 relative z-10 border-t border-black/10 bg-gray-50">
          <div className="w-full px-6 md:px-16 lg:px-32 xl:px-40 max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight mb-8">Why Choose <span className="text-gradient bg-gradient-to-r from-[#FF3B00] to-[#FFD700] bg-clip-text text-transparent">M4Y?</span></h2>
