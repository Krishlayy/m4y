              ...
              {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    <label className="block text-sm font-black uppercase tracking-widest text-black">Name *</label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-black uppercase tracking-widest text-black">Work Email *</label>
                    <input
                      required
                      type="email"
                      className="w-full px-4 py-3 transition-transform duration-200 focus:-translate-y-1 focus:-translate-x-1"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="block text-sm font-black uppercase tracking-widest text-black">Company</label>
                      <input
                        type="text"
                        className="w-full px-4 py-3 transition-transform duration-200 focus:-translate-y-1 focus:-translate-x-1"
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-black uppercase tracking-widest text-black">Revenue</label>
                      <select className="w-full px-4 py-3 transition-transform duration-200 focus:-translate-y-1 focus:-translate-x-1">
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-black uppercase tracking-widest text-black">Primary Goal *</label>
                    <textarea
                      required
                      rows={4}
