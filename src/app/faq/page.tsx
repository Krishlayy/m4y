    ...
    <>
      ...
      <main className="min-h-screen bg-white text-[#0A0A0A] overflow-hidden">
        ...
        <section className="py-24 relative z-10">
          <div className="w-full px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1000px] mx-auto">
            <div className="space-y-6">
              {faqs.map((faq) => (
                ...
                >
                  ...
                  >
                    <span className="text-2xl md:text-3xl font-black uppercase tracking-tight pr-8">{faq.question}</span>
