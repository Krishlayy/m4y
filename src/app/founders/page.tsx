      ...
      <main className="min-h-screen selection:bg-yellow-500/30">
        ...
        <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
          <div className="container relative z-10 mx-auto px-6 max-w-7xl">
            ...
            >
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter tracking-tight mb-8">
        ...
        <section className="py-24 relative z-10 border-y border-black/10">
          <div className="w-full px-6 md:px-12 lg:px-24 max-w-[1400px] mx-auto">
            {/* Tech & Engineering */}
            <div className="mb-24">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter mb-12 text-center">Tech & Engineering</h2>
              <motion.div 
                  ...
                  <motion.div key={founder.id || founder.name} variants={itemVariants} className="flex">
                    <div className="modern-card p-8 w-full h-full flex flex-col group relative overflow-hidden">
                      ...
                      <div className="mb-8 relative z-10">
                        <h4 className="text-xs font-black uppercase tracking-tighter tracking-wider mb-3">Superpowers</h4>
            ...
            {/* Brand & Marketing */}
            <div>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter mb-12 text-center">Brand & Marketing</h2>
              <motion.div 
                variants={containerVariants}
                initial="hidden"
                whileInView="show"
        ...
        <section className="py-24 relative z-10">
          <div className="w-full px-6 md:px-12 lg:px-24 max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter mb-8">Ready to work with our team?</h2>
