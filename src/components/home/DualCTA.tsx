  ...
  return (
    <section className="bg-white border-t-4 border-black">
      <div className="grid grid-cols-1 md:grid-cols-2">
        {/* Join our Team */}
        <Link href="/careers" className="group relative block aspect-square md:aspect-auto md:h-[700px] overflow-hidden bg-black text-white cursor-pointer">
          ...
          <div className="absolute inset-0 p-12 md:p-20 flex flex-col justify-between z-20">
            ...
            <h2 className="text-5xl md:text-8xl font-bold uppercase tracking-tighter max-w-[300px] leading-[0.9]">
              Join <br /> Our Team
            </h2>
          </div>
        </Link>
