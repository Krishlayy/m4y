          ...
          {founders.map((f, i) => (
            ...
            >
              ...
              <div className={`w-20 h-20 border-4 ${f.textColor === 'text-white' ? 'border-white' : 'border-black'} overflow-hidden mb-6 relative z-10 ${f.textColor === 'text-white' ? 'bg-white/20' : 'bg-black/10'}`}>
                ...
                <img src={f.avatar} alt={f.name} className="w-full h-full object-cover mix-blend-luminosity opacity-80 group-hover:opacity-100 group-hover:mix-blend-normal transition-all" />
              </div>
