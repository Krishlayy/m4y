...
export default function Hero() {
  ...
  return (
    <section ref={targetRef} className="relative w-full min-h-[100dvh] flex items-center bg-[#D0E5FF] overflow-hidden py-24 md:py-32">
      <InteractiveGrid />
      <DiagonalMarquee />
      <div className="relative z-10 w-full px-6 md:px-16 lg:px-32 xl:px-40 pointer-events-none flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-[450px] shrink-0 relative min-h-[280px] h-auto flex items-center justify-center lg:justify-end pointer-events-auto">
