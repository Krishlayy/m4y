...
// Using a simplified categories list. In a real scenario, this could be extracted dynamically
const categories = ["All", "Marketing", "SEO", "Design", "Development"];
        ...
        <motion.div layout className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <AnimatePresence mode="popLayout">
            {displayedProjects.map((project) => (
              ...
              >
                {/* Image Placeholder */}
                <div className="w-full aspect-[4/3] bg-[#F4F4F5] mb-6 relative overflow-hidden flex items-center justify-center border-2 border-black">
                  {project.coverImage ? (
                    <img src={project.coverImage} alt={project.title} className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  ) : (
                    <>
