      ...
      {active && (
        ...
        >
          ...
          >
            ...
            <h1 
              className="text-4xl md:text-7xl font-bold mb-8 uppercase tracking-widest"
              style={{ textShadow: "0 0 10px #00E676, 0 0 20px #00E676" }}
            >
            ...
            <div className="bg-white/5 border border-[#00E676]/30 p-6 mb-8 text-lg">
              ...
              <div className="flex gap-4">
                <button 
                  ...
                  className="bg-[#00E676] text-black px-6 py-2 font-bold uppercase hover:bg-white transition-colors cursor-pointer"
                >
                  Exit Terminal
                </button>
              </div>
