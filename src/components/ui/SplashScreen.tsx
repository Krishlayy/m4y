            ...
            <AnimatePresence mode="wait">
              {step === 1 ? (
                <motion.div
                  ...
                  className="absolute text-[100px] sm:text-[150px] md:text-[250px] lg:text-[350px] font-black uppercase tracking-tighter text-[#FFD700] leading-none mix-blend-screen"
                ...
                >
                  <h2 className="text-4xl sm:text-6xl md:text-8xl lg:text-[120px] font-black uppercase tracking-tighter text-[#FFD700] leading-[1] md:leading-[0.9] text-center break-words w-full" style={{ textShadow: "6px 6px 0px #000" }}>
                    Marketing <br/> 4 You
                  </h2>
                </motion.div>
              )}
